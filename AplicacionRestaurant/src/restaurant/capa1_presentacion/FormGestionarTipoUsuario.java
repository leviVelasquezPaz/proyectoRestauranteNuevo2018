 ...
 * @author INGENIERIA
 */
public class FormGestionarTipoUsuario extends javax.swing.JDialog {

    private TipoUsuario tipoUsuario;
    private List<TipoUsuario> listaTipoUsuario;
    private GestionarTipoUsuarioServicio gestionarTipoUsuarioServicio;
    private FormDatosTipoUsuario formDatosTipoUsuario;

    public FormGestionarTipoUsuario(java.awt.Frame parent, boolean modal) throws Exception {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        gestionarTipoUsuarioServicio = new GestionarTipoUsuarioServicio();
        listaTipoUsuario = gestionarTipoUsuarioServicio.mostrarTipoUsuarios();
        inicializarTabla();
        obtenerDatosTabla();
    ...
    private void inicializarTabla() {
        ...
        tablaTipoUsuarios.setModel(modeloTabla);
    ...
    private void obtenerDatosTabla() {
        ...
        try {
            ModeloTabla modeloTabla = (ModeloTabla) tablaTipoUsuarios.getModel();
            modeloTabla.eliminarTotalFilas();
            for (TipoUsuario tipoUsuario : listaTipoUsuario) {
                filaTabla = new Fila();
                filaTabla.agregarValorCelda(tipoUsuario.getTipoUsuarioCodigo());
                filaTabla.agregarValorCelda(tipoUsuario.getTipoUsuarioNombre());
                filaTabla.agregarValorCelda(tipoUsuario.getTipoUsuarioDescripcion());
                filaTabla.agregarValorCelda(tipoUsuario.getTipoUsuarioEstado());
    ...
    private void initComponents() {
        ...
        tablaTipoUsuarios = new rojerusan.RSTableMetro();
        ...
        jLabel2.setText("Mantenedor Gestionar Tipo Usuario");
        ...
        tablaTipoUsuarios.setAltoHead(30);
        tablaTipoUsuarios.setColorBackgoundHead(new java.awt.Color(68, 138, 255));
        tablaTipoUsuarios.setColorSelBackgound(new java.awt.Color(253, 173, 1));
        tablaTipoUsuarios.setGrosorBordeFilas(0);
        tablaTipoUsuarios.setGrosorBordeHead(0);
        tablaTipoUsuarios.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                tablaTipoUsuariosMousePressed(evt);
            }
        });
    ...
    private void tablaTipoUsuariosMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaTipoUsuariosMousePressed
        int fila = tablaTipoUsuarios.getSelectedRow();
        String codigo = tablaTipoUsuarios.getValueAt(fila, 0).toString();
        try {
            tipoUsuario = gestionarTipoUsuarioServicio.buscarPorCodigo(Integer.parseInt(codigo.trim()));
            inabilitarBotones(false);

        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e.getMessage());
        }
    }//GEN-LAST:event_tablaTipoUsuariosMousePressed
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        try {
            FormDatosTipoUsuario h = new FormDatosTipoUsuario(this);
            h.setVisible(true);
            listaTipoUsuario = gestionarTipoUsuarioServicio.mostrarTipoUsuarios();
            obtenerDatosTabla();
            inabilitarBotones(true);
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        try {
            formDatosTipoUsuario = new FormDatosTipoUsuario(this, tipoUsuario);
            formDatosTipoUsuario.setVisible(true);
            listaTipoUsuario = gestionarTipoUsuarioServicio.mostrarTipoUsuarios();
            obtenerDatosTabla();
            tipoUsuario = null;
            inabilitarBotones(true);
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        try {
            if (!txtBuscar.getText().equals("")) {
                tipoUsuario = null;
                listaTipoUsuario = gestionarTipoUsuarioServicio.buscarPorNombre(txtBuscar.getText().trim());
                obtenerDatosTabla();
                txtBuscar.setText("");
            } else {
                tipoUsuario = null;
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        if (tipoUsuario != null) {
            ...
            try {
                int registros_afectados = gestionarTipoUsuarioServicio.eliminarTipoUsuario(tipoUsuario);
    ...
    private rojerusan.RSTableMetro tablaTipoUsuarios;
